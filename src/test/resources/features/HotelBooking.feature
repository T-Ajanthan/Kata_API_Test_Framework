...
#    Then the response should contain booking details matching the request
    ...
    Examples:
      | roomid | firstname | lastname | depositpaid | checkin     | checkout    | email                  | phone        |
      | 3      | Lucas     | Martinez | true        | 2025-12-12  | 2025-12-16  | lucas.martinez@test.com | 55512345678  |
      | 1      | Aisha     | Patel    | false       | 2025-11-06  | 2025-11-11  | aisha.patel@test.com    | 55587654321  |
